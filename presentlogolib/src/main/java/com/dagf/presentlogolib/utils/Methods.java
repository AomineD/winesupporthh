...
import com.dagf.presentlogolib.utils.adapters.AdapterPlaylistDialog;
...
public class Methods {
    ...
    public void shareSong(ItemSong itemSong, Boolean isOnline) {
        if (isOnline) {
            ...
            sharingIntent.putExtra(Intent.EXTRA_SUBJECT, context.getResources().getString(R.string.share_song));
            sharingIntent.putExtra(Intent.EXTRA_TEXT, context.getResources().getString(R.string.listening) + " - " + itemSong.getTitle() + "\n\nvia " + context.getResources().getString(R.string.app_name) + " - http://play.google.com/store/apps/details?id=" + context.getPackageName());
            ...
            try {
                ...
                share.putExtra(Intent.EXTRA_TEXT, context.getResources().getString(R.string.listening) + " - " + itemSong.getTitle() + "\n\nvia " + context.getResources().getString(R.string.app_name) + " - http://play.google.com/store/apps/details?id=" + context.getPackageName());
    ...
    public void showInterAd(final int pos, final String type) {
           this.interAdListener.onClick(pos, type);
